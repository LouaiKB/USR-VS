...
bin/usr: obj/main.o obj/io_service_pool.o obj/safe_counter.o
	${CC} -o $@ $^ -pthread -L${BOOST_ROOT}/lib -lboost_thread -lboost_system -lboost_filesystem -lboost_date_time -L${RDKIT_ROOT}/lib -lMolTransforms -lFingerprints -lFileParsers -lSmilesParse -lSubstructMatch -lGraphMol -lAlignment -lRDGeneral -L${MONGODBCXXDRIVER_ROOT}/sharedclient -lmongoclient
